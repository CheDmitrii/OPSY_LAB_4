...
PANEL_HW_SOURCE_Visu=C:/Users/admin/Documents/KVBO-04-21/lab_4/lab_4/Physical/Config1/Hardware.hw 
...
PAGE_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/Visu/Pages/Init_Page.page \
	...
	$(AS_PROJECT_PATH)/Logical/Visu/Pages/LEDS.page \
	$(AS_PROJECT_PATH)/Logical/Visu/Pages/GRAFIK.page 
...
TRD_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/Visu/Trends/TrendData_1.trd \
	...
	$(AS_PROJECT_PATH)/Logical/Visu/Trends/TrendData_9.trd \
	$(AS_PROJECT_PATH)/Logical/Visu/Trends/TrendData_10.trd \
	$(AS_PROJECT_PATH)/Logical/Visu/Trends/TrendData_11.trd \
	$(AS_PROJECT_PATH)/Logical/Visu/Trends/TrendData_12.trd \
	$(AS_PROJECT_PATH)/Logical/Visu/Trends/TrendData_13.trd 

TRE_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/Visu/Trends/Trend_3.tre \
...
$(PANEL_HW_VCI_Visu): $(PANEL_HW_SOURCE_Visu) $(VC_LIBRARY_LIST_Visu) $(KEYMAP_SOURCES_Visu)
	$(VCHWPP) -f '$<' -o '$@' -n Visu -d Visu -pal '$(PALFILE_Visu)' -c '$(AS_CONFIGURATION)' -p '$(AS_PLC)' -ptemp '$(AS_TEMP_PLC)' -B 'D4.52' -L '' -verbose 'False' -profile 'False' -hw '$(CPUHWC)' -warninglevel 2 -so $(VC_STATIC_OPTIONS_Visu) -sos $(VC_STATIC_OPTIONS_Shared) -fp '$(AS_VC_PATH)/Firmware/V4.52.0/SG4' -sfas -prj '$(AS_PROJECT_PATH)' -apj 'lab_4' -vcob '$(VCOBJECT_Visu)'
...
$(TEMP_PATH_Visu)/page.GRAFIK.vco: $(AS_PROJECT_PATH)/Logical/Visu/Pages/GRAFIK.page $(VC_LANGUAGES_Visu)
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu) -P '$(AS_PROJECT_PATH)' -ds '$(SRC_PATH_Visu)/StyleSheets/Color.vcs' -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4520 -sfas
...
$(TEMP_PATH_Visu)/tpr.NumPad.vco: $(AS_PROJECT_PATH)/Logical/Visu/TouchPads/NumPad.tpr
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu) -prj 'C:/Users/admin/Documents/KVBO-04-21/lab_4/lab_4/Logical/Visu' -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4520 -sfas
...
$(TEMP_PATH_Visu)/trd.TrendData_9.vco: $(AS_PROJECT_PATH)/Logical/Visu/Trends/TrendData_9.trd
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4520 -sfas


$(TEMP_PATH_Visu)/trd.TrendData_10.vco: $(AS_PROJECT_PATH)/Logical/Visu/Trends/TrendData_10.trd
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4520 -sfas


$(TEMP_PATH_Visu)/trd.TrendData_11.vco: $(AS_PROJECT_PATH)/Logical/Visu/Trends/TrendData_11.trd
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4520 -sfas


$(TEMP_PATH_Visu)/trd.TrendData_12.vco: $(AS_PROJECT_PATH)/Logical/Visu/Trends/TrendData_12.trd
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4520 -sfas


$(TEMP_PATH_Visu)/trd.TrendData_13.vco: $(AS_PROJECT_PATH)/Logical/Visu/Trends/TrendData_13.trd
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4520 -sfas
